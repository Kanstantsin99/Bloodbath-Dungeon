...
var upgrade_pool: AbilityWeightedTable = AbilityWeightedTable.new()
...
func _ready() -> void:
	upgrade_pool.add_item(upgrade_axe, 100)
	upgrade_pool.add_item(upgrade_sword_rate, 10)
	upgrade_pool.add_item(upgrade_sword_damage, 10)
	upgrade_pool.add_item(upgrade_player_speed, 100)
...
func pick_upgrades(quantity: int = 2):
